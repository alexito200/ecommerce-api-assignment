...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Vitoria96!@localhost/e_commerce_api'
db = SQLAlchemy(app)
ma = Marshmallow(app)
...
def add_orders():
    ...
    new_order = Order(id=order_data['id'], date=order_data['date'], delivery_date=order_data['delivery_date'], order_products=order_data['order_products'], customer_id=order_data['customer_id'])
